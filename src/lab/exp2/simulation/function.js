window.view = {
	...
	displayFunctionForrightangletriangle: function () {
	    document.getElementById('functionrightangletriangle').innerHTML += 'float area_rightangletriangle (float a,float b)<br>{<br> &emsp; float area = a*b;<br> &emsp; return area;<br>}'
	},
